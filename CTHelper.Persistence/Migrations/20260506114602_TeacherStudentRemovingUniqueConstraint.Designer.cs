...
namespace CTHelper.Persistence.Migrations
{
    ...
    [Migration("20260506114602_TeacherStudentRemovingUniqueConstraint")]
    partial class TeacherStudentRemovingUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.GroupAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("group_assignment", null, t =>
                        {
                            t.HasCheckConstraint("CK_assignment_positive_values", "default_attempts_allowed >= 0");
                        });
                });

            modelBuilder.Entity("CTHelper.Domain.Entities.Image", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.Section", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.StudentAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("GroupAssignmentId")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("student_assignment", null, t =>
                        {
                            t.HasCheckConstraint("CK_assignment_positive_values", "attempts_left >= 0");
                        });
                });

            modelBuilder.Entity("CTHelper.Domain.Entities.Subject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.Group", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.Subject", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.GroupAssignment", b =>
                {
                    ...
                    b.HasOne("CTHelper.Domain.Entities.User", "Teacher")
                        .WithMany("IssuedGroupAssignments")
                        .HasForeignKey("TeacherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.Image", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.User", "Owner")
                        .WithMany("UserImages")
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.UserSession", "Session")
                        .WithOne("RefreshToken")
                        .HasForeignKey("CTHelper.Domain.Entities.RefreshToken", "SessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.StudentAssignment", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.GroupAssignment", "GroupAssignment")
                    ...
                    b.HasOne("CTHelper.Domain.Entities.User", "Teacher")
                        .WithMany("IssuedStudentAssignments")
                        .HasForeignKey("TeacherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.Topic", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.Section", "Section")
                        .WithMany("Topics")
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.User", b =>
                {
                    b.HasOne("CTHelper.Domain.Entities.Image", "Avatar")
                        .WithMany()
            ...
            modelBuilder.Entity("CTHelper.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("IssuedGroupAssignments");

                    b.Navigation("IssuedStudentAssignments");
